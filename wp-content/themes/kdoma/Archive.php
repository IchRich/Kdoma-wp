        ...
        <div class="container section__header">
            <div class="header">
                ...
                <div class="breadcrumbs header__filters">
                    <!-- Десктопный триггер -->
                    <button id="filter_trigger_desktop" class="filter_trigger" aria-haspopup="dialog"
                        aria-expanded="false" aria-controls="filter_dropdown">
                    ...
                    <div class="filter_dropdown" id="filter_dropdown" hidden>
                        <div class="filter_dropdown__panel" role="dialog" aria-modal="false"
                            ...
                            <div class="mobile_drawer__head">
                                ...
                                <button type="button" class="mobile_drawer__close filter_dropdown__close"
                            ...
                            <div class="filter_dropdown__body">
                                ...
                                <details class="filter_acc" open>
                                    <summary class="filter_acc__sum">Год выпуска<img src="Assets/image/Galochka.svg"
                                            alt=""></summary>
                                    <div class="filter_acc__body">
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2025">
                                            2025</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2024">
                                            2024</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2023">
                                            2023</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2022">
                                            2022</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2021">
                                            2021</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2020">
                                            2020</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2019">
                                            2019</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2018">
                                            2018</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2017">
                                            2017</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2016">
                                            2016</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2015">
                                            2015</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2014">
                                            2014</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2013">
                                            2013</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2012">
                                            2012</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2011">
                                            2011</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2010">
                                            2010</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2009">
                                            2009</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2008">
                                            2008</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2007">
                                            2007</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2006">
                                            2006</label>
                                        <label class="filter_check"><input type="checkbox" name="year[]" value="2005">
                                            2005</label>
