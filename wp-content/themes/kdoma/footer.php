<footer class="site_footer" role="contentinfo">
    <div class="site_footer__inner">
        ...
        <section class="site_footer__col site_footer__col_brand" aria-labelledby="footer_brand">
            ...
            <a class="site_footer__logo" href="/" aria-label="На главную">
                <img src="<?php bloginfo('template_url') ?>/Assets/image/LogoKD.svg" width="75" height="50"
                    alt="Логотип КД">
            </a>
            ...
            <div class="site_footer__col footer_social" aria-label="Соцсети">
                ...
                <ul class="site_footer__list_media">
                    <li class="site_footer__list_TG">
                        <img src="<?php bloginfo('template_url') ?>/Assets/image/TgLogo.png" width="30" height="30"
                            alt="<UNK> <UNK>">
                        <a class="site_footer__link" href="https://t.me/">Telegram</a>
                    </li>
                    <li class="site_footer__list_VK">
                        <img src="<?php bloginfo('template_url') ?>/Assets/image/VkLogo.png" width="30" height="30"
                            alt="<UNK> <UNK>" />
        ...
        <nav class="site_footer__col footer_sections" aria-labelledby="footer_sections_1">
            ...
            <ul class="site_footer__list">
                ...
                <li><a class="site_footer__link" href="<?php echo get_page_link(84); ?>">Дизайнеры</a></li>
        ...
        <nav class="site_footer__col footer_sections footer_sections_extra" aria-labelledby="footer_sections_2">
            ...
            <ul class="site_footer__list_second">
                ...
                <li class="red_marker"><a class="site_footer__link site_footer__link_accent"
                        href="DesignSchool.html">Школа дизайна</a></li>
                <li class="red_marker"><a class="site_footer__link site_footer__link_accent" href="/week">Неделя
                        дизайна</a></li>
                <li class="red_marker"><a class="site_footer__link site_footer__link_accent" href="/award">Премия</a>
                </li>
            </ul>
        </nav>
    ...
    <div class="site_footer__bottom">
        ...
        <div class="site_footer__dev_container">
            ...
            <img src="<?php bloginfo('template_url') ?>/Assets/image/LogoKant.svg" width="138" height="14"
                alt="<UNK> <UNK>">
        </div>
    </div>
</footer>